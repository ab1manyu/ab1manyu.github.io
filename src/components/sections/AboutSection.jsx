      ...
      <div className="glass-panel md:col-span-5 p-6 flex flex-col gap-6">
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            <span className={`${styles.domainTag} ${styles.domainPython}`}>Python</span>
            <span className={`${styles.domainTag} ${styles.domainReact}`}>ReactJS</span>
            <span className={`${styles.domainTag} ${styles.domainJava}`}>Java</span>
            <span className={`${styles.domainTag} ${styles.domainMatlab}`}>MATLAB</span>
          </div>
        </div>
        <div>
          <div className="font-mono text-xs text-gray-500 mb-2">SECONDARY_DOMAINS</div>
          <div className="flex flex-wrap gap-2">
            <span className={`${styles.domainTag} ${styles.domainUIUX}`}>UI / UX</span>
            <span className={`${styles.domainTag} ${styles.domainAI}`}>AI</span>
            <span className={`${styles.domainTag} ${styles.domainData}`}>Data Science</span>
          </div>
        </div>
      </div>

      <a href="resume.pdf" target="_blank" rel="noopener noreferrer" className={`glass-panel md:col-span-4 p-6 flex items-center justify-between cursor-pointer ${styles.resumeCard}`}>
        <div>
        ...
        <div className={`w-10 h-10 rounded-full border border-defense-border flex items-center justify-center ${styles.resumeIconWrap}`}>
