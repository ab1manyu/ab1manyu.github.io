  ...
  useEffect(() => {
    const updateClock = () => {
      ...
      const newTimeString = isUTC
        ? now.toLocaleTimeString("en-US", { timeZone: "UTC", hour12: false, hour: "2-digit", minute: "2-digit", second: "2-digit" }) + " UTC"
        : now.toLocaleTimeString("en-US", { timeZone: "America/Denver", hour12: false, hour: "2-digit", minute: "2-digit", second: "2-digit" }) + " MST";
      ...
      onUpdate: () => {
        ...
        for (let i = 0; i < targetLength; i++) {
          ...
          if (progress < charStart) {
            ...
            currentString += GLITCH_CHARS[Math.floor(Math.random() * GLITCH_CHARS.length)];
          }
        }
