...
const moves = [
  {
    name: "Earthquake",
    dmg: 100,
    type: types.find((t) => t.name === "Fighting"),
  },
  {
    name: "Thunderbolt",
    dmg: 90,
    type: types.find((t) => t.name === "Electric"),
  },
...
const cardsData = Array.from({ length: totalCards }, (_, i) => {
  ...
  const shuffledLegendaryMoves = [...legendaryMoves].sort(
    () => 0.5 - Math.random()
  );
  ...
  return {
    ...
    isLegendary,
    image: isLegendary
      ? "/kai/kaiLegendary.jpg"
      : shuffledImages[i % shuffledImages.length],
    attack1: isLegendary
      ? {
          ...shuffledLegendaryMoves[0],
          dmg: shuffledLegendaryMoves[0].dmg + 40,
        }
      : shuffledMoves[0],
    attack2: isLegendary
      ? {
          ...shuffledLegendaryMoves[1],
          dmg: shuffledLegendaryMoves[1].dmg + 40,
        }
      : shuffledMoves[1],
    flavor: isLegendary
    ...
    >
      ...
      <div
        ...
        style={{
          height: "45vh",
          background:
            "radial-gradient(ellipse 80% 60% at 50% 100%, rgba(16,185,129,0.13) 0%, rgba(16,185,129,0.05) 45%, transparent 100%)",
        }}
      />
        ...
        {cardsData.map((card, idx) => (
          <div
            ...
            style={{
              ...
              opacity: 0,
              pointerEvents: "none",
              border: card.isLegendary
                ? "1.5px solid #c8960c"
                : "1px solid var(--border-color)",
              color: card.isLegendary ? "#f0c040" : "var(--accent-solid)",
              boxShadow: card.isLegendary
                ? "0 0 24px rgba(200,150,12,0.35), 0 4px 32px rgba(0,0,0,0.8)"
                : undefined,
            }}
          >
            <div
            ...
            >
                ...
                >
                  ...
                  >
                    <card.type.icon
                      ...
                      style={{
                        color: card.isLegendary ? "#f0c040" : card.type.color,
                      }}
                    />
                  </div>
                </div>
              ...
              >
                ...
                {card.isLegendary && (
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(180deg, rgba(200,150,12,0.08) 0%, transparent 40%)",
                    }}
                  />
                )}
              </div>
              ...
              <div
                ...
                style={{
                  ...
                  borderTop: card.isLegendary
                    ? "1px solid #c8960c"
                    : "1px solid var(--border-color)",
                  borderBottom: card.isLegendary
                    ? "1px solid #c8960c"
                    : "1px solid var(--border-color)",
              ...
              >
                ...
                >
                  <div className="flex items-center gap-1 sm:gap-2">
                    ...
                    >
                      <card.attack1.type.icon
                        className="w-full h-full"
                        style={{
                          color: card.isLegendary
                            ? "#f0c040"
                            : card.attack1.type.color,
                        }}
                      />
                    </div>
                ...
                >
                  <div className="flex items-center gap-1 sm:gap-2">
                    ...
                    >
                      <card.attack2.type.icon
                        className="w-full h-full"
                        style={{
                          color: card.isLegendary
                            ? "#f0c040"
                            : card.attack2.type.color,
                        }}
                      />
                    </div>
                    <span className="font-bold text-xs sm:text-sm tracking-tight">
