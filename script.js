...
function initRadar() {
    ...
    radarBtn.addEventListener('click', (e) => {
        ...
        for (let i = 0; i < targetCount; i++) {
            ...
            jet.className = 'fighter-jet-dynamic fixed z-[45] opacity-0 transition-opacity duration-500 flex flex-col items-center gap-1 pointer-events-none';
            ...
            jet.innerHTML = `
                ...
                <span class="text-[8px] font-mono text-defense-accent bg-black/80 px-1 border border-defense-accent">BOGEY_0${i + 1}</span>
            `;
...
function initLoader() {
    ...
    const logs = ["> MEMORY_TEST... PASS", "> ENCRYPTION_KEYS... LOADED", "> UPLINK_ESTABLISHED... OK", "> LOADING_INTERFACE... 100%"];
    let progress = 0;
    let logIndex = 0;
